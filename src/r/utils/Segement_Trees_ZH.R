...
BK <- st_read("//speedy16-36/data_15/_PROJEKTE/20260401_Boschettissimo/01_Daten/GIS/REF_DATA/BaumKadaster_ZH/ref_perim.gpkg")
out_data_path <- "//speedy16-36/data_15/_PROJEKTE/20260401_Boschettissimo/01_Daten/GIS/PROCESSED_DATA/BaumKadaster_ZH/"
...
process_cell <- function(i) {
  ...
  seg_cell(vhm_cell, e_buf, LN_2025_path, local_out, NULL)
  ...
  final_out <- file.path(out_data_path, "BK.gpkg")
